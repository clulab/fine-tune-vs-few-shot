import logging
import sys
import torch  # Add torch import for dtype
...
def train():
    ...
    # Prepare model for k-bit training before adding LoRA adapters
    ...
    # Trainer automatically saves PEFT adapters correctly
