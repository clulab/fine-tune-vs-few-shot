...
for SHOT in 20 40 60 80 100 120 140 160 180 200
  do
    export PROMPT_DATA_PATH=/home/xinsu/source-data-model-free-da/raw-data/negation_few_shot_examples/negation_few_shot_examples_${SHOT}.json
    export PREDS_PATH=/export/share/projects/mcai/xinsu/sfda/few_shot_experiments_outputs/negation_from_i2b2_to_mimic/Llama-3.2-3B-Instruct-shot_${SHOT}
    ...
    python /home/xinsu/source-data-model-free-da/experiments/run_vllm_prompting.py \
        ...
        --test_data /home/xinsu/source-data-model-free-da/raw-data/negation-qa/i2b2/test_sent_to_class_name.json \
    ...
    python /home/xinsu/source-data-model-free-da/experiments/run_vllm_prompting.py \
        --ckpt_dir $MODEL_NAME \
        --tokenizer $MODEL_NAME \
        --test_data /home/xinsu/source-data-model-free-da/raw-data/negation-qa/mimic/test_sent_to_class_name.json \
        --prompt_data $PROMPT_DATA_PATH \
